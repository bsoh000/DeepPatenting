...
# batch_size = 100
# train_x_batch, train_y_batch = tf.train.batch([xy[0:n_feat], xy[-1:]],
...
# Weight & Bias
# W = tf.Variable(tf.random_normal([n_hidden, n_classes]), name="Weights")
...
with tf.Session() as sess:
    ...
    # save summary
    train_writer = tf.summary.FileWriter('./logs/LSTM/train/'+filename, sess.graph)
    test_writer = tf.summary.FileWriter('./logs/LSTM/test/'+filename, sess.graph)
...
print("LSTM Training Time:", (time.time()-t))